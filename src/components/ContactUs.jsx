                                    ...
                                    <ul class="mt-4">
                                        <li class="flex items-center">
                                            ...
                                            <a href="#" class="text-[#007bff] text-sm ml-4">
                                                <strong>info@vedanttechnobani.com</strong>
                                            </a>
                                        </li>
                                    </ul>
                                    <ul class="mt-4">
                                    ...
                                    <ul class="mt-4">
                                        <li class="flex items-center">
                                            <div class="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" width="25px" height="25px" fill='#007bff' viewBox="0 0 479.058 479.058">
                                            ...
                                            <a href="javascript:void(0)" class="text-[#007bff] text-sm ml-4">
                                                <strong>shubhamnikam727@gmail.com</strong>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
